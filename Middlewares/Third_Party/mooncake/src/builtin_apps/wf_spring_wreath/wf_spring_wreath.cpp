...
namespace MOONCAKE {
    namespace BUILTIN_APP {
        ...
        {
            /* Clock */
            DEBUG_PRINT(_data.string_buffer, sizeof(_data.string_buffer), "%02d:%02d", _data.time_ptr->hour, _data.time_ptr->min);
//            lv_label_set_text(_data.label_clock, _data.string_buffer);
            lv_label_set_text(_data.label_clock, "23:32");


            /* Infos */
            DEBUG_PRINT(_data.string_buffer, sizeof(_data.string_buffer), "~~~~~~~~~~~~~~~~\n%d/%d %s.  %ld steps",
